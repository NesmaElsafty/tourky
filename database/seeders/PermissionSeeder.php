...
class PermissionSeeder extends Seeder
{
    ...
    private function definitions(): array
    {
        return [
            ...
            [
                'name' => 'routes.view',
                'display_name_en' => 'View routes',
                'display_name_ar' => 'عرض المسارات',
                'description_en' => 'List and read route definitions.',
                'description_ar' => 'عرض قائمة المسارات وتفاصيلها.',
                'group_en' => 'routes',
                'group_ar' => 'المسارات',
            ],
            [
                ...
                'description_en' => 'Create, update, or delete routes and view inactive listings.',
                'description_ar' => 'إنشاء أو تعديل أو حذف المسارات وعرض القوائم غير النشطة.',
                'group_en' => 'routes',
                'group_ar' => 'المسارات',
            ],
            [
