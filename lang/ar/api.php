...
return [
    ...
    'contact_us' => [
        'list_retrieved' => 'تم جلب بيانات التواصل بنجاح.',
        'created' => 'تم إنشاء بيانات التواصل بنجاح.',
        'updated' => 'تم تحديث بيانات التواصل بنجاح.',
        'retrieved' => 'تم جلب بيانات التواصل بنجاح.',
    ...
    'track_trips' => [
        'stored' => 'تم حفظ سجل تتبع الرحلة بنجاح.',
        'admin_list_retrieved' => 'تم جلب سجلات تتبع الرحلات بنجاح.',
        'admin_retrieved' => 'تم جلب سجل تتبع الرحلة بنجاح.',
        'not_found' => 'سجل تتبع الرحلة غير موجود.',
        'server_error' => 'حدث خطأ. يرجى المحاولة لاحقاً.',
        'message_arrival' => 'الكابتن :captain وصل إلى :point في :at.',
        'message_pickup' => 'الكابتن :captain أكّد :client من :point في :at.',
        'message_dropoff' => 'الكابتن :captain أكّد :client من :point في :at.',
        'message_reject' => 'الكابتن :captain رفض العميل :client بسبب :reason من نقطة :point في :at.',
        'notification_title_arrival' => 'الكابتن وصل',
        'notification_title_rejection' => 'تم إلغاء الحجز',
        'notification_rejection' => 'الكابتن :captain رفض حجزك بسبب :reason من :point في :at. تم إلغاء حجزك.',
        'message_acceptance' => 'الكابتن :captain قبل العميل :client في الرحلة رقم :trip_id بتاريخ :date الساعة :time.',
        'validation_message_max' => 'الرسالة لا يمكن أن تتجاوز 5000 حرف.',
        'validation_trip_id_required' => 'الرحلة مطلوبة.',
        'validation_trip_id_exists' => 'الرحلة المحددة غير موجودة.',
        'validation_car_id_required' => 'العربية مطلوبة.',
        'validation_car_id_exists' => 'العربية المحددة غير موجودة.',
        'validation_captain_id_required' => 'الكابتن مطلوب.',
        'validation_captain_id_exists' => 'الكابتن المحدد غير موجود.',
        'validation_captain_mismatch' => 'رقم الكابتن يجب أن يطابق الكابتن المسجل دخوله.',
        'validation_message_type_required' => 'نوع الرسالة مطلوب.',
        'validation_message_type_in' => 'نوع الرسالة يجب أن يكون arrival أو acceptance.',
        'validation_point_id_required' => 'النقطة مطلوبة لتتبع الوصول.',
        'validation_point_id_exists' => 'النقطة المحددة غير موجودة.',
        'validation_client_id_required' => 'العميل مطلوب لتتبع القبول.',
        'validation_client_id_exists' => 'العميل المحدد غير موجود.',
        'validation_client_not_on_trip' => 'هذا العميل غير مسند لعربيتك في هذه الرحلة.',
        'validation_point_not_on_trip_route' => 'النقطة المحددة لا تنتمي لمسار هذه الرحلة.',
        'validation_per_page_integer' => 'عدد العناصر في الصفحة يجب أن يكون عدداً صحيحاً.',
        'validation_per_page_min' => 'عدد العناصر في الصفحة يجب أن يكون 1 على الأقل.',
        'validation_per_page_max' => 'عدد العناصر في الصفحة لا يمكن أن يتجاوز 100.',
    ],

    'captain_trips' => [
        'notification_title_new' => 'عندك رحله جديده',
        'notification_title_trip_started' => 'بدأت الرحلة',
        'notification_title_trip_cancelled' => 'تم إلغاء الرحلة',
        'notification_trip_started_client' => 'الكابتن :captain بدأ رحلتك (:route) بتاريخ :date الساعة :time.',
        'notification_trip_started_admin' => 'الكابتن :captain بدأ الرحلة رقم :trip_id (:route) بتاريخ :date الساعة :time.',
        'notification_trip_cancelled_client' => 'الكابتن :captain ألغى رحلتك (:route) بتاريخ :date الساعة :time.',
        'notification_trip_cancelled_admin' => 'الكابتن :captain ألغى الرحلة رقم :trip_id (:route) بتاريخ :date الساعة :time.',
        ...
        'trip_cancelled' => 'تم إلغاء الرحلة بنجاح.',
