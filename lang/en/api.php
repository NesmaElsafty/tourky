...
return [
    ...
    'reservations' => [
        ...
        'route_time_pair_not_configured' => 'No schedule on this route includes both the selected pickup and drop-off times.',
        'invalid_drop_off_time' => 'The selected drop-off time is invalid.',
        'drop_off_different_route' => 'Pickup and drop-off must be on the same route.',
        'drop_off_must_differ_from_pickup' => 'Drop-off time must be different from pickup time.',
        'drop_off_must_be_after_pickup' => 'Drop-off must be later along the route than pickup.',
    ...
    'track_trips' => [
        'stored' => 'Trip tracking entry saved successfully.',
        'admin_list_retrieved' => 'Trip tracking entries retrieved successfully.',
        'admin_retrieved' => 'Trip tracking entry retrieved successfully.',
        'not_found' => 'Trip tracking entry not found.',
        'server_error' => 'Something went wrong. Please try again later.',
        'message_arrival' => 'Captain :captain arrived at :point at :at.',
        'message_pickup' => 'Captain :captain confirmed :client from :point at :at.',
        'message_dropoff' => 'Captain :captain confirmed :client from :point at :at.',
        'message_reject' => 'Captain :captain rejected client :client because :reason from the point :point at :at.',
        'notification_title_arrival' => 'Captain arrived',
        'notification_title_rejection' => 'Booking cancelled',
        'notification_rejection' => 'Captain :captain rejected your booking because :reason from :point at :at. Your reservation has been cancelled.',
        'message_acceptance' => 'Captain :captain accepted client :client for trip #:trip_id on :date at :time.',
        'validation_message_max' => 'The message may not be greater than 5000 characters.',
        'validation_trip_id_required' => 'Trip is required.',
        'validation_trip_id_exists' => 'The selected trip does not exist.',
        'validation_car_id_required' => 'Car is required.',
        'validation_car_id_exists' => 'The selected car does not exist.',
        'validation_captain_id_required' => 'Captain is required.',
        'validation_captain_id_exists' => 'The selected captain does not exist.',
        'validation_captain_mismatch' => 'Captain ID must match the authenticated captain.',
        'validation_message_type_required' => 'Message type is required.',
        'validation_message_type_in' => 'Message type must be arrival or acceptance.',
        'validation_point_id_required' => 'Point is required for arrival tracking.',
        'validation_point_id_exists' => 'The selected point does not exist.',
        'validation_client_id_required' => 'Client is required for acceptance tracking.',
        'validation_client_id_exists' => 'The selected client does not exist.',
        'validation_client_not_on_trip' => 'This client is not assigned to your vehicle on this trip.',
        'validation_point_not_on_trip_route' => 'The selected point does not belong to this trip route.',
        'validation_per_page_integer' => 'Per page must be an integer.',
        'validation_per_page_min' => 'Per page must be at least 1.',
        'validation_per_page_max' => 'Per page may not be greater than 100.',
    ],
    ...
    'captain_trips' => [
        ...
        'notification_title_trip_started' => 'Trip started',
        'notification_title_trip_cancelled' => 'Trip cancelled',
        'notification_trip_started_client' => 'Captain :captain has started your trip (:route) on :date at :time.',
        'notification_trip_started_admin' => 'Captain :captain started trip #:trip_id (:route) on :date at :time.',
        'notification_trip_cancelled_client' => 'Captain :captain has cancelled your trip (:route) on :date at :time.',
        'notification_trip_cancelled_admin' => 'Captain :captain cancelled trip #:trip_id (:route) on :date at :time.',
